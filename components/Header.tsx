...
function Header() {
  return (
    <div className=" w-full bg-white flex px-8 py-3 justify-between ">
      <div className="flex gap-4 items-center">
        ...
        <div className="flex gap-2 cursor-pointer items-center">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_48520_2522)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
            ...
            <defs>
              <clipPath id="clip0_48520_2522">
                <rect width="14" height="14" fill="white" />
              </clipPath>
            </defs>
          </svg>
          <p className=" text-[13px]">How it works</p>
        </div>
      </div>
      <div className="flex w-[400px] rounded-md gap-2 bg-gray-300/40 px-4 items-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
        ...
        <input className=" w-full bg-transparent focus:outline-none" placeholder="Search features, tutorials, etc." type="text" />
      </div>
      <div className="flex gap-3 items-center">
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clip-path="url(#clip0_48520_2532)">
        ...
        <svg
          ...
          fill="none"
        >
          <g clip-path="url(#clip0_48520_2537)">
            <circle cx="20" cy="20" r="20" fill="#E6E6E6" />
            <path

...
function Header() {
  ...
  return (
    <div className=" w-full bg-white gap-2 border-borders border-b flex px-4 md:px-8 py-3 justify-between ">
      <div className="flex gap-1 md:gap-4 items-center">
        <p className=" text-[15px] capitalize text-black">{path}</p>
        <div className="flex gap-2 cursor-pointer items-center">
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_48520_2522)">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <p className=" text-[13px] hidden md:block text-gray-800">
            How it works
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-1 md:gap-3 items-center">
        <Link className=" cursor-pointer" href={""}>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#clip0_48520_2532)">
        ...
        <Link className=" cursor-pointer" href={""}>
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_48520_2537)">
              <circle cx="20" cy="20" r="20" fill="#E6E6E6" />
              <path
